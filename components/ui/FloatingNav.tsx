  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed z-[5000] top-4 sm:top-7 md:top-10 inset-x-0 mx-auto px-5 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 rounded-lg border border-black/.1 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] items-center justify-center space-x-3 sm:space-x-4",
      ...
      >
        {navItems.map((navItem, idx: number) => (
          <Link
            ...
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500 text-xs sm:text-sm font-medium cursor-pointer"
            )}
          >
