      ...
      <div className="flex flex-col items-center max-lg:mt-10">
        ...
        <div className="h-[50vh] md:h-[30rem] w-full flex items-center justify-center overflow-hidden gap-8">
          {[1, 2].map((cardIdx) => (
            <div
              key={cardIdx}
              className="w-[90vw] md:w-[60vw] h-[280px] md:h-[320px] rounded-2xl border border-white/20 p-6 md:p-12 flex flex-col justify-between shrink-0 skeleton-shimmer bg-[#0B0F33]/90 shadow-2xl"
            >
