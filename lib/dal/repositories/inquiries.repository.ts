...
export class InquiriesRepository extends BaseRepository {
  ...
  public async createInquiry(
    ...
    return this.executeMutation("createInquiry", async () => {
  ...
  public async updateInquiryStatus(
    ...
    return this.executeMutation("updateInquiryStatus", async () => {
  ...
  public async recordInquiryReply(
    ...
    return this.executeMutation("recordInquiryReply", async () => {
